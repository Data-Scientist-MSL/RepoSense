...
exports.ArchitectureDiagramGenerator = void 0;
class ArchitectureDiagramGenerator {
     ...
     */
    async generateAsIsDiagram(gaps, level, options) {
        const diagOptions = {
            level,
            includeDefects: true,
     ...
     */
    async generateToBeDiagram(gaps, level, options) {
        const diagOptions = {
            level,
     ...
     */
    async generateComparison(gaps, level) {
    ...
    markProblematicElements(nodes, edges, gaps) {
    ...
    async applyRemediations(nodes, edges, gaps) {
    ...
    generateAnnotations(gaps, level) {
        const annotations = [];
    ...
    generateImprovementAnnotations(gaps, level) {
        const annotations = [];
    ...
    calculateDifferences(asIs, toBe) {
        const differences = [];
        // Compare nodes
    ...
    async generateComparisonSummary(differences, gaps) {
    ...
    getComponentLabel(filePath, level) {
        const fileName = filePath.split('/').pop() || filePath;
...
exports.ArchitectureDiagramGenerator = ArchitectureDiagramGenerator;
