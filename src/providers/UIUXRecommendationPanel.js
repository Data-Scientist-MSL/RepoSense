...
exports.UIUXRecommendationPanel = void 0;
const vscode = __importStar(require("vscode"));
const path = __importStar(require("path"));
class UIUXRecommendationPanel {
    static createOrShow(extensionUri, pack) {
        ...
        const panel = vscode.window.createWebviewPanel('uiuxRecommendations', '🎨 UI/UX Recommendations', column, {
            enableScripts: true,
    ...
    constructor(panel, extensionUri, pack) {
        this.disposables = [];
        this.panel = panel;
...
exports.UIUXRecommendationPanel = UIUXRecommendationPanel;
