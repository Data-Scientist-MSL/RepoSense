 ...
 */
class ReportPanel {
    constructor(panel, extensionUri, runGraph, diagramGenerator) {
        this._disposables = [];
        this._panel = panel;
        ...
        // Set panel icon
        this._panel.iconPath = vscode.Uri.joinPath(extensionUri, 'media', 'report-icon.svg');
        // Set initial HTML
     ...
     */
    static createOrShow(extensionUri, runGraph, diagramGenerator) {
        ...
        const panel = vscode.window.createWebviewPanel('reposenseReport', 'RepoSense Report', column || vscode.ViewColumn.One, {
            enableScripts: true,
            localResourceRoots: [
        ...
        ReportPanel.currentPanel = new ReportPanel(panel, extensionUri, runGraph, diagramGenerator);
    }
    /**
     * Update report data
     */
    updateReport(runGraph, diagramGenerator) {
        this._runGraph = runGraph;
        this._diagramGenerator = diagramGenerator;
        this._panel.webview.html = this._getHtmlForWebview(this._panel.webview);
    }
    ...
    _exportReport(format) {
        ...
        vscode.window.showInformationMessage(`Exporting report as ${format.toUpperCase()}...`);
    }
    /**
     * Show gap details in info panel
     */
    _showGapDetails(gapId) {
